...
const ANIMAL_TRANSLATIONS: Record<string, string> = {
  ...
  'struzzo': 'ostrich bird',
  'cammello': 'camel desert',
  ...
  'narvalo': 'narwhal ocean',
  'gorilla': 'gorilla ape',
  'camaleonte': 'chameleon lizard',
  'tucano': 'toucan bird',
  'bradipo': 'sloth animal',
  'koala': 'koala bear',
  'aquila reale': 'golden eagle bird',
  'fenicottero rosa': 'pink flamingo',
  'fenicottero': 'pink flamingo',
  ...
  'stegosauro': 'stegosaurus dinosaur',
